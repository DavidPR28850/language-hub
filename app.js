const resources = {
  ...
  french: { title:'Français', flag:'fr', quick:[{ label:'☁️ Mon dossier OneDrive', url:'https://1drv.ms/f/c/685f78fc014b807e/IgDZmxFXO5cwT6biX668IVH9AVKe5YdcLTInTWzxuXpzZiI' }], categories:{ Grammaire:[{ name:'TV5MONDE — Exercices A1 débutant', url:'https://apprendre.tv5monde.com/fr/exercices/a1-debutant', note:'Exercices de français', icon:'📺' }], 'Loisirs':[
